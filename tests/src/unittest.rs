...
use protobuf::test_messages::proto2_unittest;

#[test]
fn extreme_default_values() {
    // TODO: Revert back to function syntax when Edition 2023 is supported
    let pb = proto2_unittest::TestExtremeDefaultValues::default();
